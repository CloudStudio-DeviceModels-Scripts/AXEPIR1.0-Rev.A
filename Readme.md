...
# Parsing + Configuration Script – AXE PIR 1.0 - Rev. A

This **Parsing + Configuration** script is designed for the **AXE PIR 1.0** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AXE PIR 1.0 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AXE PIR 1.0** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
